object Form5: TForm5
  ...
  Width = 1012
  Height = 583
  Caption = #1069#1050#1047#1040#1052#1045#1053
  Color = clBtnFace
      ...
      object TabSheet1: TTabSheet
        ...
        object Panel2: TPanel
          ...
          object Label1: TLabel
            ...
            Width = 201
            Height = 16
            Caption = #1044#1040#1058#1040' '#1055#1056#1054#1042#1045#1044#1045#1053#1048#1071' '#1069#1050#1047#1040#1052#1045#1053#1040
            Font.Charset = RUSSIAN_CHARSET
            Font.Color = clWindowText
            Font.Height = -13
            Font.Name = 'Sitka Text'
        ...
        object DateTimePicker1: TDateTimePicker
          ...
          Width = 153
          Height = 24
          Date = 44146.967676319440000000
          Time = 44146.967676319440000000
          Font.Charset = RUSSIAN_CHARSET
          Font.Color = clWindowText
          Font.Height = -13
          Font.Name = 'Sitka Text'
        ...
        object BitBtn10: TBitBtn
          ...
          Width = 321
          Height = 25
          Caption = #1056#1045#1044#1040#1050#1058#1048#1056#1054#1042#1040#1058#1068' '#1058#1040#1041#1051#1048#1062#1059
          Font.Charset = RUSSIAN_CHARSET
          Font.Color = clWindowText
          Font.Height = -13
          Font.Name = 'Sitka Text'
      ...
      object TabSheet2: TTabSheet
        ...
        object Panel3: TPanel
          ...
          object RadioGroup1: TRadioGroup
            ...
            Width = 265
            Height = 81
            Caption = #1057#1054#1056#1058#1048#1056#1054#1042#1050#1040
            Font.Charset = RUSSIAN_CHARSET
            Font.Color = clWindowText
            Font.Height = -13
            Font.Name = 'Sitka Text'
            Font.Style = [fsBold]
            Items.Strings = (
              #1055#1086' '#1060#1048#1054' ('#1086#1090' '#1040' '#1076#1086' '#1071')'
              #1055#1086' '#1085#1086#1084#1077#1088#1091' '#1090#1077#1083#1077#1092#1086#1085#1072' ('#1086#1090' 1...)')
            ParentFont = False
            TabOrder = 2
          ...
          object BitBtn6: TBitBtn
            ...
            Width = 177
            Height = 25
            Caption = #1054#1058#1052#1045#1053#1040' '#1057#1054#1056#1058#1048#1056#1054#1042#1050#1048
            Font.Charset = RUSSIAN_CHARSET
            Font.Color = clWindowText
            Font.Height = -11
            Font.Name = 'Sitka Text'
  ...
  object MainMenu1: TMainMenu
    ...
    object N1: TMenuItem
      ...
      object N3: TMenuItem
        Caption = 
          #1054#1090#1095#1077#1090' "'#1069#1082#1079#1072#1084#1077#1085'" ('#1087#1077#1088#1077#1076' '#1087#1077#1095#1072#1090#1100#1102' '#1074#1099#1073#1077#1088#1080#1090#1077' '#1076#1072#1090#1091' '#1087#1088#1086#1074#1077#1076#1077#1085#1080#1103' '#1101#1082#1079#1072#1084#1077#1085#1072 +
          ')'
        OnClick = N3Click
      end
    end
  ...
  object PopupMenu1: TPopupMenu
    ...
    object N4: TMenuItem
      ...
      object N6: TMenuItem
        Caption = #1055#1086' '#1085#1086#1084#1077#1088#1091' '#1090#1077#1083#1077#1092#1086#1085#1072
        OnClick = N6Click
      end
    end
  end
